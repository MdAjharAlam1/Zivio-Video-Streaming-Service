...
<head>
    <title>Code coverage report for directory.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> directory.js</h1>
        <div class='clearfix'>
...
&nbsp;
function findPackageDirs(baseDir = <span class="branch-0 cbranch-no" title="branch not covered" >'.')</span> {
  const results = []
&nbsp;
  function walk(dir) {
    let entries
